...
initialize_stock_components :: proc (leaves: ^[dynamic]zd.Leaf_Template) {
    ...
    zd.append_leaf (leaves, string_constant ("normalize"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/normalize.ohm"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/normalize.rwr"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/normalizesupport.js"))
    zd.append_leaf (leaves, string_constant ("jsnormalize"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/jsnormalize.ohm"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/jsnormalize.rwr"))
    zd.append_leaf (leaves, string_constant ("lispnormalize"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/lispnormalize.ohm"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/lispnormalize.rwr"))
    zd.append_leaf (leaves, string_constant ("prolognormalize"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/prolognormalize.ohm"))
    zd.append_leaf (leaves, string_constant ("0d/odin/std/prolognormalize.rwr"))
}
